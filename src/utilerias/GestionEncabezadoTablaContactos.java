...
public class GestionEncabezadoTablaContactos implements TableCellRenderer{
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column){
        ...
        switch (column){
            ...
            case 1:
                jcomponent.setToolTipText("ID del contacto");
                break;
            ...
            case 3:
                ...
                break;
            case 4:
                jcomponent.setToolTipText("Clic para ver el registro completo");
                break;                   
        }
